...
function calculateStringFor2Items(data1, data2, type) {
    ...
    switch (type) {
        case "hulls":
            ...
            switch (data1.stats.weaponry.aps) {
                case 0:
                    aps = "None";
                    break;
                case 1:
            ...
            switch (data2.stats.weaponry.aps) {
                case 0:
                    aps2 = "None";
                    break;
                case 1:
            ...
            aps = data1.stats.weaponry.aps
            
            aps2 = data2.stats.weaponry.aps
            ...
            <tr><th colspan="3" class="stat_header">Modules</th></tr>
                <tr><th>Drone</th><td>${data1.stats.modules.drone}</td>
                <td style="color:${data1.stats.modules.drone,data2.stats.modules.drone};">${data2.stats.modules.drone}</tr>
                <tr><th>Sensors</th><td>${data1.stats.modules.sensors}</td>
                <td style="color:${data1.stats.modules.sensors,data2.stats.modules.sensors};">${data2.stats.modules.sensors}</tr>
            ...
            <tr><th>APS</th><td>${aps_to_string[aps]}</td>
                <td style="color: ${redOrGreen(data1.stats.weaponry.aps,data2.stats.weaponry.aps)};">${aps_to_string[aps2]}</td></tr>
            ${data1.stats.weaponry.aps || data2.stats.weaponry.aps ? `<tr><th>Protection</th>
                ${data1.stats.weaponry.aps > 1 ? "<td><img src=\"\" id=\"aps_img1\"></td>" : "<td></td>"}
                ${data2.stats.weaponry.aps > 1 ? "<td><img src=\"\" id=\"aps_img2\"></td>" : "<td></td>"}</tr>` : ""}
