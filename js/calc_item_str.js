...
var ammo_stats_titles = {
    ...
    "max_g_force": ["Max G-Force", "", 1],
    "ignore_smoke": ["Ignore Smoke", "", 1],
    "guide_time": ["Guide Time", "s", 1],
    "kinetic": ["Kinetic", "", 1],
    "irccm": ["IRCCM", "", 1],
    "launch_speed": ["Launch Speed", "", 1]
};
...
function calculateStringForItem(data, type, aps_img, secondary_data) {
    ...
    switch (type) {
        case "hulls":
            ...
            switch (data.stats.weaponry.aps) {
                case 0:
                    aps = "None";
                    break;
                case 1:
            ...
            <tr><th colspan="2" class="stat_header">Modules</th></tr>
            <tr><th>Drone</th><td>${data.stats.modules.drone}</td></tr>
            <tr><th>Sensors</th><td>${data.stats.modules.sensors}</td></tr>
            ...
            <tr><th>APS</th><td>${aps_to_string[aps]}</td></tr>
            ${aps > 1 ? `<tr><th>Protection</th><td><img src="${aps_img}"></td></tr>` : ""}
